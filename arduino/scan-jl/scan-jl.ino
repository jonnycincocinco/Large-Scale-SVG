...
Adafruit_StepperMotor *myStepper2 = AFMStop.getStepper(20, 2);
...
void forwardstep2() {  
  myStepper2->onestep(BACKWARD, FORWARD);
}
void backwardstep2() {  
